...
### Toolchain directory
TOOLCHAIN_DIR = ${HOME}/Software/Coding/toolchain/gcc-arm-none-eabi-10.3-2021.07/bin/
...
CMSIS_ST_INC_DIR = CMSIS/Device/ST/STM32F4xx/Include
USER_INC = inc
...
### Sources
CMSIS_SYS_SRC = CMSIS/Device/ST/STM32F4xx/Source/Templates/system_stm32f4xx.c
CMSIS_START_SRC = CMSIS/Device/ST/STM32F4xx/Source/Templates/gcc_ride7/startup_stm32f401xx.s
...
flash:
	openocd -d -f board/st_nucleo_f4.cfg -c "program main.elf verify reset exit"
